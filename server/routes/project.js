...
router.post('/add_project', [
                        ...
                        check('imagePath').trim().not().isEmpty().withMessage('Must Upload an Image'),
                        check('imageName').trim().not().isEmpty().withMessage('Must Upload an Image'),
                        ],isAuth, projectController.postProject);
router.delete('/delete_project/:id', isAuth, projectController.deleteProject)
